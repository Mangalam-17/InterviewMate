...
//                 dive deeper in to concepts, and organize everything your way.
...
const LandingPage = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
              ...
              <h1 className="text-5xl text-black font-medium mb-6 leading-tight">
                Ace Interview with <br />
                <span className="text-transparent bg-clip-text bg-[radial-gradient(circle,#FF9324_0%,#FCD760_100%)] bg-[size:200% 200%] animate-text-shine font-semibold">
                  AI-Powered
                </span>
                {""} Learning
              </h1>
      ...
      {/* Fixed Modal - using string instead of component */}
      <Modal
        isOpen={openAuthModal}
        onClose={() => {
          setOpenAuthModal(false);
          setCurrentPage("login"); // Fixed: using string "login" instead of Login component
        }}
        hideHeader
      >
        <div>
